...
ALTER TABLE table_equipment ADD CONSTRAINT fk_equipment_rating FOREIGN KEY (rating_id) REFERENCES rating(rating_id);
...
INSERT INTO customer (customer_id, first_name, last_name, date_of_birth, address, phone_number, customer_email, review_id) -- to add review_id
VALUES
  ('C00001', 'Alice', 'Williams', '1995-03-12', '123 Main St, City, Country', '+1234567890', 'alice@example.com'),
  ('C00002', 'Bob', 'Brown', '1980-08-25', '456 Elm St, City, Country', '+1987654321', 'bob@example.com'),
  ('C00003', 'Eva', 'Martinez', '1976-11-03', '789 Oak St, City, Country', '+9876543210', 'eva@example.com'),
  ('C00004', 'David', 'Jones', '1990-05-20', '234 Maple St, City, Country', '+1122334455', 'david@example.com'),
  ('C00005', 'Emma', 'Taylor', '1985-09-10', '567 Pine St, City, Country', '+9988776655', 'emma@example.com'),
  ('C00006', 'James', 'Anderson', '1978-04-15', '890 Cedar St, City, Country', '+5566778899', 'james@example.com'),
  ('C00007', 'Olivia', 'Davis', '1992-07-18', '345 Oak St, City, Country', '+4433221122', 'olivia@example.com'),
  ('C00008', 'Michael', 'Wilson', '1987-12-30', '678 Elm St, City, Country', '+7788990011', 'michael@example.com'),
  ('C00009', 'Sophia', 'Moore', '1983-03-25', '901 Birch St, City, Country', '+6677889900', 'sophia@example.com'),
  ('C00010', 'William', 'Clark', '1995-08-02', '123 Pineapple St, City, Country', '+2233445566', 'william@example.com'),
  ('C00011', 'Emily', 'Thomas', '1998-01-05', '456 Orange St, City, Country', '+8899001122', 'emily@example.com'),
  ('C00012', 'Jacob', 'Jackson', '1976-09-20', '789 Strawberry St, City, Country', '+0011223344', 'jacob@example.com'),
  ('C00013', 'Isabella', 'Harris', '1989-06-14', '234 Mango St, City, Country', '+5566778899', 'isabella@example.com'),
  ('C00014', 'Alexander', 'Allen', '1993-12-28', '567 Banana St, City, Country', '+9988776655', 'alexander@example.com'),
  ('C00015', 'Abigail', 'Lee', '1975-10-03', '890 Lemon St, City, Country', '+1122334455', 'abigail@example.com'),
  ('C00016', 'Matthew', 'Young', '1981-04-08', '123 Peach St, City, Country', '+4433221122', 'matthew@example.com'),
  ('C00017', 'Ava', 'Scott', '1990-07-13', '456 Cherry St, City, Country', '+7788990011', 'ava@example.com'),
  ('C00018', 'Ethan', 'King', '1986-11-17', '789 Grape St, City, Country', '+6677889900', 'ethan@example.com'),
  ('C00019', 'Mia', 'Wright', '1997-02-28', '901 Pear St, City, Country', '+2233445566', 'mia@example.com'),
  ('C00020', 'Charlotte', 'Lopez', '1982-05-10', '123 Kiwi St, City, Country', '+8899001122', 'charlotte@example.com'),
  ('C00021', 'Liam', 'Gonzalez', '1991-08-22', '456 Coconut St, City, Country', '+0011223344', 'liam@example.com'),
  ('C00022', 'Harper', 'Lewis', '1979-03-07', '789 Avocado St, City, Country', '+5566778899', 'harper@example.com'),
  ('C00023', 'Ella', 'Martin', '1994-12-01', '234 Guava St, City, Country', '+9988776655', 'ella@example.com'),
  ('C00024', 'Jackson', 'Lee', '1988-06-25', '567 Papaya St, City, Country', '+1122334455', 'jackson@example.com'),
  ('C00025', 'Avery', 'Hill', '1992-11-09', '890 Mango St, City, Country', '+4433221122', 'avery@example.com'),
  ('C00026', 'Scarlett', 'Cook', '1977-04-15', '123 Banana St, City, Country', '+7788990011', 'scarlett@example.com'),
  ('C00027', 'Lucas', 'Murphy', '1984-09-28', '456 Orange St, City, Country', '+6677889900', 'lucas@example.com'),
  ('C00028', 'Evelyn', 'Nelson', '1996-02-03', '789 Lemon St, City, Country', '+2233445566', 'evelyn@example.com'),
  ('C00029', 'Madison', 'Baker', '1980-07-16', '901 Peach St, City, Country', '+8899001122', 'madison@example.com'),
  ('C00030', 'Jackson', 'Cooper', '1993-10-30', '234 Cherry St, City, Country', '+0011223344', 'jackson@example.com'),
  ('C00031', 'Aria', 'Hill', '1978-05-24', '567 Mango St, City, Country', '+5566778899', 'aria@example.com'),
  ('C00032', 'Sebastian', 'Green', '1985-01-18', '890 Kiwi St, City, Country', '+9988776655', 'sebastian@example.com'),
  ('C00033', 'Lily', 'Carter', '1990-03-02', '123 Coconut St, City, Country', '+1122334455', 'lily@example.com'),
  ('C00034', 'Gabriel', 'Adams', '1995-08-17', '456 Avocado St, City, Country', '+4433221122', 'gabriel@example.com'),
  ('C00035', 'Chloe', 'Gray', '1983-11-21', '789 Papaya St, City, Country', '+7788990011', 'chloe@example.com'),
  ('C00036', 'Zoey', 'Barnes', '1998-04-04', '901 Guava St, City, Country', '+6677889900', 'zoey@example.com'),
  ('C00037', 'Carter', 'Foster', '1976-09-08', '234 Pear St, City, Country', '+2233445566', 'carter@example.com'),
  ('C00038', 'Grace', 'Perry', '1988-01-12', '567 Kiwi St, City, Country', '+8899001122', 'grace@example.com'),
  ('C00039', 'Riley', 'Bennett', '1992-04-26', '890 Coconut St, City, Country', '+0011223344', 'riley@example.com'),
  ('C00040', 'Eleanor', 'Howard', '1980-07-01', '123 Avocado St, City, Country', '+5566778899', 'eleanor@example.com'),
  ('C00041', 'Lincoln', 'Reed', '1996-10-15', '456 Papaya St, City, Country', '+9988776655', 'lincoln@example.com'),
  ('C00042', 'Natalie', 'Sanders', '1984-02-19', '789 Mango St, City, Country', '+1122334455', 'natalie@example.com'),
  ('C00043', 'Nolan', 'Flores', '1979-05-23', '901 Orange St, City, Country', '+4433221122', 'nolan@example.com'),
  ('C00044', 'Hannah', 'Ross', '1994-11-07', '234 Lemon St, City, Country', '+7788990011', 'hannah@example.com'),
  ('C00045', 'Landon', 'Butler', '1987-03-11', '567 Peach St, City, Country', '+6677889900', 'landon@example.com'),
  ('C00046', 'Layla', 'Simmons', '1990-06-25', '890 Cherry St, City, Country', '+2233445566', 'layla@example.com'),
  ('C00047', 'Isaac', 'Woods', '1997-09-12', '123 Mango St, City, Country', '+8899001122', 'isaac@example.com'),
  ('C00048', 'Nova', 'Coleman', '1977-12-04', '456 Banana St, City, Country', '+0011223344', 'nova@example.com'),
  ('C00049', 'Leah', 'Griffin', '1982-08-18', '789 Orange St, City, Country', '+5566778899', 'leah@example.com'),
  ('C00050', 'Eli', 'Ward', '1995-01-21', '901 Kiwi St, City, Country', '+9988776655', 'eli@example.com');
...
VALUES
('GA00001', 'Space Adventure', 'G01', '1980-07-15', 'P00001', 'E', 'R00001'),
('GA00002', 'Fantasy Quest', 'G02', '1985-11-20', 'P00001', 'T', 'R00002'),
('GA00003', 'Mystery Island', 'G03', '1990-05-22', 'P00002', 'M', 'R00003'),
('GA00004', 'Castle Siege', 'G01', '1992-12-09', 'P00002', 'E10+', 'R00004'),
('GA00005', 'Cybernetic Wars', 'G04', '1999-08-15', 'P00003', 'T', 'R00005'),
('GA00006', 'Galactic Battles', 'G05', '2001-02-26', 'P00003', 'M', 'R00006'),
('GA00007', 'Ocean Explorer', 'G06', '2003-09-17', 'P00004', 'E', 'R00007'),
('GA00008', 'Desert Rally', 'G02', '2004-06-30', 'P00004', 'E10+', 'R00008'),
('GA00009', 'Sky High Adventure', 'G01', '2005-12-12', 'P00005', 'T', 'R00009'),
('GA00010', 'Dinosaur Park', 'G03', '2007-07-21', 'P00005', 'E', 'R00010'),
('GA00011', 'Ninja Warrior', 'G02', '2009-03-03', 'P00006', 'T', 'R00011'),
('GA00012', 'Pirate Treasures', 'G01', '2010-10-14', 'P00006', 'E10+', 'R00012'),
('GA00013', 'Robot Factory', 'G04', '2011-04-23', 'P00007', 'E', 'R00013'),
('GA00014', 'Monster Zoo', 'G03', '2013-11-19', 'P00007', 'E', 'R00014'),
('GA00015', 'Time Travelers', 'G05', '2015-02-27', 'P00008', 'T', 'R00015'),
('GA00016', 'Arctic Expedition', 'G06', '2016-08-06', 'P00008', 'E10+', 'R00016'),
('GA00017', 'Haunted Mansion', 'G02', '2017-09-29', 'P00009', 'M', 'R00017'),
('GA00018', 'Jungle Journey', 'G01', '2018-03-15', 'P00009', 'E', 'R00018'),
('GA00019', 'Space Odyssey', 'G05', '2019-07-22', 'P00010', 'T', 'R00019'),
('GA00020', 'Lost in Time', 'G03', '2020-12-05', 'P00010', 'E10+', 'R00020'),
('GA00021', 'Ice World', 'G06', '2021-05-14', 'P00011', 'E', 'R00021'),
('GA00022', 'Cyberpunk City', 'G04', '2022-01-20', 'P00011', 'M', 'R00022'),
('GA00023', 'Formula Rush', 'G02', '2023-04-18', 'P00012', 'E', 'R00023'),
('GA00024', 'Lunar Landing', 'G05', '2024-03-03', 'P00012', 'T', 'R00024'),
('GA00025', 'Medieval Lords', 'G01', '1984-08-16', 'P00001', 'E10+', 'R00025'),
('GA00026', 'Virtual Detective', 'G03', '1986-11-22', 'P00001', 'T', 'R00026'),
('GA00027', 'Alien Invasion', 'G04', '1987-07-17', 'P00002', 'M', 'R00027'),
('GA00028', 'Racing Legends', 'G02', '1988-02-09', 'P00002', 'E', 'R00028'),
('GA00029', 'Wizard Academy', 'G01', '1989-12-15', 'P00003', 'E', 'R00029'),
('GA00030', 'Treasure Island', 'G03', '1991-05-24', 'P00003', 'E10+', 'R00030'),
('GA00031', 'Samurai Honor', 'G02', '1993-08-30', 'P00004', 'T', 'R00031'),
('GA00032', 'Future Wars', 'G05', '1994-04-12', 'P00004', 'M', 'R00032'),
('GA00033', 'Deep Sea Quest', 'G06', '1996-11-28', 'P00005', 'E', 'R00033'),
('GA00034', 'Sky Fighters', 'G01', '1998-03-05', 'P00005', 'T', 'R00034'),
('GA00035', 'Antarctic Adventure', 'G06', '2000-07-19', 'P00006', 'E', 'R00035'),
('GA00036', 'Canyon Challenge', 'G02', '2002-01-22', 'P00006', 'E10+', 'R00036'),
('GA00037', 'Dragon Realm', 'G03', '2004-06-11', 'P00007', 'T', 'R00037'),
('GA00038', 'Fantasy Skies', 'G01', '2006-10-17', 'P00007', 'M', 'R00038'),
('GA00039', 'Mystic Forest', 'G03', '2008-03-24', 'P00008', 'E', 'R00039'),
('GA00040', 'Cyber Hacker', 'G04', '2009-12-09', 'P00008', 'E10+', 'R00040'),
('GA00041', 'Global Racing', 'G02', '2011-06-13', 'P00009', 'T', 'R00041'),
('GA00042', 'Orbital Station', 'G05', '2012-09-22', 'P00009', 'M', 'R00042'),
('GA00043', 'Ancient Ruins', 'G01', '2014-02-18', 'P00010', 'E', 'R00043'),
('GA00044', 'Thunderstorm Racers', 'G02', '2016-04-30', 'P00010', 'E10+', 'R00044'),
('GA00045', 'Neptune Exploration', 'G06', '2018-11-29', 'P00011', 'T', 'R00045'),
('GA00046', 'Zombie City', 'G04', '2020-10-05', 'P00011', 'M', 'R00046'),
('GA00047', 'Royal Knights', 'G01', '2022-01-16', 'P00012', 'E', 'R00047'),
('GA00048', 'Storm Pilots', 'G05', '2023-08-23', 'P00012', 'T', 'R00048'),
('GA00049', 'Quantum Break', 'G04', '2024-02-12', 'P00012', 'M', 'R00049'),
('GA00050', 'Planet Explorer', 'G06', '2024-04-29', 'P00012', 'E', 'R00050');
